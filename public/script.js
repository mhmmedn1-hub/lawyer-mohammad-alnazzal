...
window.generateAgencyText = function(type) {
    ...
    switch (type) {
        case 'divorce':
            ...
            text = `أنا الموكل ${clientName} ليكونوا وكيلاً ينوب عني بالخصومة والمحاكمة مع الحق العام ومع ${opponentName} بالأمور الشرعية كافة من تثبيت الطلاق والتفريق لعلة الشقاق ولكافة العلل وتثبيت المخالعة الرضائية وتبادل ألفاظها الإيجاب والقبول وتحديد بدلها و قبضها أو تثبيت الزواج قضائياً أو أدارياً وتبادل ألفاظ إيجاب والقبول وتحديد المهرين المؤجل والمعجل. وحضور مجالس التحكيم ومجلس العائلي ومطالبة بتعديل المهرين والنفقة.\n\nالاقرار والأسقاط وسلوك كافة طرق الطعن والطعن بالنقض و مجلس الدولة و القبض والصرف و الصلح والأبراء والأنكار و التحكيم و الاستلام و التسليم و التنازل أمام القضاء و دفع السلف والرسوم والكفالات القضائية واستردادها ومراجعة كافة دوائر الدولة ومؤسساتها و وزاراتها و أقسام الشرطة والمباحث الجنائية و التنفيذ و الحجز وكل ما يتشأ ويتفرع عن ذلك.`;
            break;
        case 'marriage':
            title = "وكالة خاصة بتثبيت الزواج";
            const fatherName = prompt("الرجاء إدخال اسم الأب (بصفته ولي جبري):");
            const daughterName = prompt("الرجاء إدخال اسم الابنة:");
            const husbandName = prompt("الرجاء إدخال اسم الزوج (الطرف الآخر):");

            if (!fatherName || !daughterName || !husbandName) {
                alert("تم الإلغاء لعدم إكمال البيانات.");
                return;
            }

            text = `أنا الموقع أدناه ${fatherName} بصفتي ولي جبري على ابنتي ${daughterName} ومن ابنتي ${daughterName}، ليكونوا وكيلاً ينوب عنا بالخصومة والمحاكمة مع الحق العام ومع ${husbandName} بكافة الأمور الشرعية من تثبيت الزواج قضائياً وإدارياً وتبادل ألفاظ الإيجاب والقبول وتحديد المهرين المعجل والمؤجل ومراجعة الاحوال المدنية والخارجية ومختلف المحاكم الشرعية.\n\nسلوك كافة طرق الطعن والطعن بالنقض و مجلس الدولة و القبض والصرف و الصلح والأبراء والأنكار و الأقرار و الأسقاط و التحكيم و الاستلام و التسليم و التنازل أمام القضاء و دفع السلف والرسوم والكفالات القضائية واستردادها ومراجعة كافة دوائر الدولة ومؤسساتها و وزاراتها و أقسام الشرطة والمباحث الجنائية و التنفيذ و الحجز وكل ما يتشأ ويتفرع عن ذلك.`;
            break;
        case 'sale':
            title = "وكالة خاصة بتثبيت البيع أو الشراء";
            const opponentName = prompt("الرجاء إدخال اسم الطرف الآخر (الخصم):");
            if (!opponentName) return;
            const saleOrPurchase = prompt("هل الوكالة لتثبيت (بيع) أم (شراء)؟", "بيعي");
            const propertyNumber = prompt("الرجاء إدخال رقم العقار:");
            const shareAmount = prompt("الرجاء إدخال مقدار الحصة السهمية:");
            const realEstateArea = prompt("الرجاء إدخال المنطقة العقارية:");

            if (!saleOrPurchase || !propertyNumber || !shareAmount || !realEstateArea) {
                alert("تم الإلغاء لعدم إكمال البيانات.");
                return;
            }

            text = `أنا الموقع أدناه ${clientName}، ليكونوا وكيلاً ينوب عني بالخصومة والمحاكمة مع الحق العام ومع أي شخص كان وبأية صفة كانت بكل ما يتعلق بتثبيت ${saleOrPurchase} للعقار رقم (${propertyNumber}) أو الحصة السهمية ومقدارها (${shareAmount}) /2400 سهم من منطقة (${realEstateArea}) عقارية وكل ما ينشأ ويتفرع عن ذلك.\n\nسلوك كافة طرق الطعن والطعن بالنقض و مجلس الدولة و القبض والصرف و الصلح والأبراء والأنكار و الأقرار و الأسقاط و التحكيم و الاستلام و التسليم و التنازل أمام القضاء و دفع السلف والرسوم والكفالات القضائية واستردادها ومراجعة كافة دوائر الدولة ومؤسساتها و وزاراتها و أقسام الشرطة والمباحث الجنائية و التنفيذ و الحجز وكل ما يتشأ ويتفرع عن ذلك.`;
            break;
        case 'criminal':
            title = "وكالة خاصة جزائية";
            text = `أنا الموقع أدناه ${clientName}، ليكونوا وكيلا ينوب عني بالخصومة والمحاكمة مع الحق العام ومع أي شخص كان وبأية صفة كانت بكل ما يتعلق بأي دعوى جزائية أو ضبط أو جرم يظهر بحقي والمرافعة أمام المحاكم الجزائية والقضاء العسكري وطلب كف البحث و طلب رد اعتبار واسترداد خلاصات الحكم وكل ما ينشأ ويتفرع عن ذلك أمام القضاء والنيابة العامة والمحامي لعام.\n\nسلوك كافة طرق الطعن والطعن بالنقض ومجلس الدولة والقبض والصرف والصلح والأبراء والأنكار و الأقرار و الأسقاط و التحكيم و الاستلام و التسليم و التنازل أمام القضاء و دفع السلف والرسوم والكفالات القضائية واستردادها ومراجعة كافة دوائر الدولة ومؤسساتها و وزاراتها و أقسام الشرطة والمباحث الجنائية و التنفيذ و الحجز وكل ما يتشأ ويتفرع عن ذلك.`;
            break;
    }
