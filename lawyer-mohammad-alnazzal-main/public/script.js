...
window.handleLawyerLogin = function() {
  ...
  // The raw input is checked first for "محمد النزال"
  ...
  const isLawyerUser = userVal === 'محمد النزال' || validLawyerNames.includes(normalizedInput) || matchesSpecialCase || normalizedInput === 'admin';
  const isCorrectPassword = passVal === '6503536'; // تم تحديث كلمة المرور هنا
